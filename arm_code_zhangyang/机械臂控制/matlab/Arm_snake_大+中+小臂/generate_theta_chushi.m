...
% 第一个直管道
    ...
    cen1 = [1.11 + piping_adjust_x + R_adjust*2, -0.27+piping_adjust_y-R_adjust*2+0.19, z1 , R];   % 弯管道二用
    cen2 = [1.11 + piping_adjust_x + R_adjust*2, -0.67+piping_adjust_y-R_adjust*4+0.19, z1 , R];   % 直管道二用
