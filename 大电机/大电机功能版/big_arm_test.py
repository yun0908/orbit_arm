...
'''
    白电机 指令集
'''
send_data_POS0 = ["44", "00", "00", "00", "00"]   # position0
send_data_POS70 = ["44", "c7", "71", "13", "00"]
send_data_POS80 = ["44", "e3", "38", "16", "00" ]
send_data_POS90 = ["44", "00", "00", "19", "00"]  # position90
send_data_POS100 = ["44", "1c", "c7", "1b", "00"] # position100
send_data_POS110 = ["44", "38", "8e", "1e", "00"]
send_data_POS120 = ["44", "55", "55", "21", "00"]

send_data_POS180 = ["44", "00", "00", "32", "00"] # position180
send_data_POS360 = ["44", "00", "00", "64", "00"] # position360
...
read_speed1 = ["18"]   # 读取正向速度
read_speed2 = ["19"]   # 读取反向速度
read_data_position = ["41"] # 读取电机 电流（0）、速度（2）、位置（4）
send_speed1 = ["24", "e8", "03", "00", "00"]  # 设置正向速度
send_speed2 = ["25", "08", "fc", "ff", "ff"]  # 设置反向速度
send_speed3 = ["24", "f4", "01", "00", "00"]    #500
send_speed4 = ["25", "10", "fe", "ff", "ff"]

len_send_stop = len(send_data_disable)  # 1字节
len_send_move = len(send_data_POS0)  # 5字节
...
# # 获取电流（0）、速度（2）、位置（4）
# for i in range(len_send_ID):
#     print("******************获取电流（0）、速度（2）、位置（4）**********************")
#     sendcan1(ID_CAN1[i], len_send_stop, read_data_position)
#     ecan.ClearBuffer(USBCAN2, DevIndex, Channel1)
#     time.sleep(0.1)
#     print("********************************success**************************************")
...
#设置最大正向允许速度
for i in range(len_send_ID):
    sendcan1(ID_CAN1[i], len_send_move, send_speed3)
...
#设置最小负向允许速度
for i in range(len_send_ID):
    sendcan1(ID_CAN1[i], len_send_move, send_speed4)
...
#     # sendcan1(ID_CAN1[j], len_send_move, send_data_POS90)
#     sendcan1(ID_CAN1[j], len_send_stop, read_data_position)
#     time.sleep(2)
#     # ReadCAN()
#     ecan.ClearBuffer(USBCAN2, DevIndex, Channel1)
#
...
sendcan1(ID_CAN1[1], len_send_move, send_data_POS90)
time.sleep(2)
ecan.ClearBuffer(USBCAN2, DevIndex, Channel1)
