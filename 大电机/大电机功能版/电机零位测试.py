...
send_data_POS2 = ["44", "00", "00", "19", "00"]  # position2
...
send_data_offset = ["53", "00", "00", "19", "00"]     #设置偏移量 90度
read_data_offset = ["54"]   #获取偏移量
read_data_position = ["41"]
...
for j in range(len_send_ID):
    # sendcan1(ID_CAN1[j], len_send_move, send_data_POS2)
...
#  #设置偏移量
# for j in range(len_send_ID):
#     sendcan1(ID_CAN1[j], len_send_move, send_data_offset)
#     ecan.ClearBuffer(USBCAN2, DevIndex, Channel1)

#读取偏移量
# for j in range(len_send_ID):
#     sendcan1(ID_CAN1[j], len_send_stop, read_data_offset)
#     ecan.ClearBuffer(USBCAN2, DevIndex, Channel1)
