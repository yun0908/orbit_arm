...
send_data_disable = ["FF", "FF", "FF", "FF", "FF", "FF", "FF", "Fd"]  # 失能
send_data2 = ["7f", "ff", "82", "80", "00", "66", "67", "ff"]  # v正1 kd 2
send_data3 = ["7f", "ff", "7d", "60", "00", "66", "67", "ff"]  # v负1 kd 2
send_data4 = ["7f", "ff", "85", "10", "00", "66", "67", "ff"]  # v正2 kd 2
send_data5 = ["FF", "FF", "FF", "FF", "FF", "FF", "FF", "Fe"]
len_sdata0 = len(send_data0)
# print(ID_CAN1[2], len_sdata0, send_data_enable)
send_data5 = ["85", "52", "7f", "f0", "50", "66", "67", "ff"]  # p0.52 kp9.89/9.77 kd 2
send_data6 = ["7a", "ac", "7f", "f0", "50", "66", "67", "ff"]  # p-3.14 kp9.89/9.77 kd 2
...
for j in range(len_send_ID):
    print("----加速度----")
    sendcan1(ID_CAN1[j], len_send_stop, send_data_a1)
    print("--------")
    time.sleep(0.1)
    print("-------减速度-----")
    sendcan1(ID_CAN1[j], len_send_stop, send_data_a2)
    print("---------")
    # ReadCAN()
    ecan.ClearBuffer(USBCAN2, DevIndex, Channel1)
