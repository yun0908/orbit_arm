...
send_data_bai3 = ["1d", "e8", "fc", "ff", "ff"]     # v1    反转
send_data_bai4 = ["1d", "e8", "03", "00", "00"]     # v2    正转
send_data_bai5 = ["1d", "e8", "20", "00", "00"]     # v3    正转
...
# sendcan1(ID_CAN1[1], len_send_db0, send_data_bai0)
...
for i in range(60):
    if (i % 2 == 0):
        ...
        ss= send_data_bai3
    for j in range(1):
        sendcan1(ID_CAN1[j], len_send_db1, ss)
        ReadCAN()
        ecan.ClearBuffer(USBCAN2, DevIndex, Channel1)
        # time.sleep(1)
        # time.sleep(0.05)
